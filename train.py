...
print ('The fc neuron number is {} and the output number is {}'.format(para.fc_1_out, para.outputClassN))
...
# ===============================Build model=============================
    ...
    prepareData(inputTrain, inputTest, neighborNumber, pointNumber)
    ...
    weight_dict = 0#weight_dict_fc(trainLabel, para)
    testLabelWhole = []
    ...
    for epoch in range(para.max_epoch):
        ...
        train_average_loss, train_average_acc, loss_reg_average = trainOneEpoch(inputTrain,
                                                                                trainLabel,
                                                                                para, sess, 
                                                                                trainOperaion, 
                                                                                weight_dict,
        ...
        test_average_loss, test_average_acc, test_predict = evaluateOneEpoch(inputTest, 
                                                                             testLabel,
                                                                             para, sess, 
                                                                             trainOperaion)
